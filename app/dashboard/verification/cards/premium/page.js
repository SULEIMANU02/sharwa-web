...
export default function CardPremiumPage() {
  ...
  const onSubmit = async (data) => {
    setMessage('')
    try {
      await api.post('/verify/card/premium', data)
      setMessage('Premium card verification submitted')
    } catch (e) {
  ...
  return (
    <div className="max-w-md">
      <h2 className="text-xl font-semibold mb-4">Card Verification - Premium</h2>
